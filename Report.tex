...
\author{
	\IEEEauthorblockN{
		...
		Rajan Subramaniam\IEEEauthorrefmark{3}
	}\\
	\IEEEauthorblockA{
		Department of Computer Science,\\
...
\begin{IEEEkeywords}
Real-Time Data, Websocket, real time display data, analysis, communction, AJAX, data communications aspects, Web servers
\end{IEEEkeywords}
